        ...
        <ul class="mb-6 flex flex-col gap-4 ">
          ...
          <li style="max-height: 38px">
            <a href="{{ route('categories.index') }}"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="17 " height="17" fill="#4A4A4A">
...
          </li>
          ...
          <li style="max-height: 38px">
            <a href="{{ route('products.index') }}"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" width="20" height="20" fill="#4A4A4A">
                <!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
...
          </li>
      ...
      <div>
        ...
        <ul class="mb-6 flex flex-col gap-4">
          ...
          <!-- Menu Item Invoice -->
          <li>
            <a href="invoice.html" @click="selected = (selected === 'Invoice' ? '':'Invoice')" class="menu-item group"
